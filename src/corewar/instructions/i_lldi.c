    ...
    coding_byte_t coding_byte)
{
    ...
    return begin_pc + (params[0] + params[1]);
}

int i_lldi(war_t *war, __attribute_maybe_unused__ champion_t *champ,
    process_t *process)
{
