...
const op_t op_tab[] = {
    ...
    {"ldi", 3, {T_REG | T_DIR | T_IND, T_REG | T_DIR | T_IND, T_REG}, 10, 25,
        "load index", &i_ldi},
    {"sti", 3, {T_REG, T_REG | T_DIR | T_IND, T_REG | T_DIR | T_IND}, 11, 25,
        "store index", &i_sti},
    {"fork", 1, {T_DIR}, 12, 800, "fork", &i_fork},
    {"lld", 2, {T_DIR | T_IND, T_REG}, 13, 10, "long load", &i_lld},
    {"lldi", 3, {T_REG | T_DIR | T_IND, T_REG | T_DIR | T_IND, T_REG}, 14, 50,
